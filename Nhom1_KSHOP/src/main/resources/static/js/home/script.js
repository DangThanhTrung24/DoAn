            ...
            <div class="product text-center">
                ...
                <div class="product-details">
                    ...
                    <div class="ratings-container">
                        ...
                        <a href="/product/${e.product_code}-${e.id}" class="rating-reviews">(1 Reviews)</a>
                    </div>
...
const loadProductSwip = (data, wrapClass) => {
    ...
    data.forEach((e, i) => {
        ...
        html += /*html */`<div class="product-wrap product text-center">
            <figure class="product-media">
                <a href="#">
...
http.get("http://localhost:8080/Products/get/0/2")
    .then(data => loadProductDealHotOfDay(data.data.products))

//swiper-top-best-seller
http.get("http://localhost:8080/Products/get/0/9")
    .then(data => loadProductTopSwip(data.data.products))

//new-products
http.get("http://localhost:8080/Products/get/0/30")
    .then(data => loadProduct(data.data.products, '.new-products'))
